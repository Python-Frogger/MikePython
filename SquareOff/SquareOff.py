...
pygame.mixer.init()
bullet1_sound = pygame.mixer.Sound('bullet1.mp3')
death1_sound = pygame.mixer.Sound('death1.mp3')
hurt1_sound = pygame.mixer.Sound('hurt1.mp3')
selection_music = pygame.mixer.Sound('musicinstrumental.mp3')
game1_music = pygame.mixer.Sound('musicrock.mp3')
...
# loop for game lives
    ...
    if stage_selection == False:
        ...
        for p in players:
            ...
            if joystick.get_axis(5) > -1 and p["current_bullets"] > 0 and pygame.time.get_ticks() >= p["time_last_shot_fired"] + p["fire_rate"] and p["is_reloading"] == False:
                ...
                bullets = bullets + [ {"x": p["x"] + 20 * p["gun_x"], "y": p["y"] + 20 * p["gun_y"], "x_speed": p["gun_x"] * p["bullet_speed"],
                     ...
                     "bounce": 0.3, "colour": p["colour"], "damage": p["bullet_damage"]}
                ]
                p["current_bullets"] -= 1
        ...
        for bullet in bullets:
            ...
            pygame.draw.circle(screen, bullet["colour"], (bullet["x"], bullet["y"]), 5)
